...
| 725    | InvalidNotify Value already same  | The value given in InvalidNotify is already the same |
...
| 809    | WelcomeMSG invalid Channel        | The input for welcome message channel is not a valid guild Channel. |
| 810    | WelcomeMSG invalid Mention        | The input for welcome message mention is not valid. |
