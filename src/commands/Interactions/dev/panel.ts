...
- <:Akira_Active_Dev:$if[$environment==main;1263809794632974346;1271543843157971014]> Joined: \`Join time stamp\`
        ;true]
        $addField[Stats:;
- <:Date:$if[$environment==main;1263809801817821278;1271546151543373906]> Slash Commands Used: \`NaN\`
- <:Date:$if[$environment==main;1263809801817821278;1271546151543373906]> Message Commands Used: \`NaN\`
        ;true]
