...
const commands: Command[] = [
  {
    ...
    code: `
      ...
      $onlyIf[$checkContains[$getVar[rp-commandblocked;$get[user]];*;cry]==false;$customError[722;cry]]
      $onlyIf[$checkContains[$getVar[rp-blocked;$get[user]];$get[author]]!=true;$customError[722;cry]]

      $c[-----------------------------------MAIN-----------------------------------]
      $let[message;$replace[$replace[$message;$message[0] ;];$message[0];]]

      $setVar[cry-give;$get[author];$sum[$getVar[cry-give;$get[author];0];1]]

      $if[$get[user]!=null;
        $setVar[cry-gotten;$get[user];$sum[$getVar[cry-gotten;$get[user];0];1]]
      ]
      ...
      $if[$get[userID]!=$authorID;
        ...
        $footer[$replace[$replace[$i18n[$get[lang];message.roleplay.negative.cry.$if[$getVar[cry-gotten;$get[author]]==1;footer.oneSingle;footer.one]];{{author}};$if[$guildID!=;$nickname;$username];1];{{amount}};$getVar[cry-give;$get[author]];1] | $replace[$replace[$i18n[$get[lang];message.roleplay.negative.cry.footer.$if[$getVar[cry-gotten;$get[user];0]==1;two;twoSingle]];{{amount}};$getVar[cry-gotten;$get[user];0];-1];{{user}};$try[$nickname[$guildID;$get[userID]];$username[$get[userID]]];-1]]
      ;
        $let[msg;$i18n[$get[lang];message.roleplay.negative.cry.descriptionSingle]]
        $description[$replace[$replace[$get[msg];{{author}};**$if[$guildID!=;$nickname;$username]**;1];{{user}};**$username[$get[userID]]**;1]$if[$get[message]!=;\n"$get[message]"]]
        $footer[$replace[$replace[$i18n[$get[lang];message.roleplay.negative.cry.$if[$getVar[cry-gotten;$get[author]]==1;footer.oneSingle;footer.one]];{{author}};$if[$guildID!=;$nickname;$username];1];{{amount}};$getVar[cry-give;$get[author]];1]]
