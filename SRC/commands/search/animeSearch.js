module.exports = [{
    name: "anime",
	aliases: ["anime-search","animesearch","search-anime","searchanime"],
	module: "Search",
	version: "1.0",
    sourcecode: "https://github.com/LynnuxDev/Akira/blob/main/SRC/commands/search/animeSearch.js",
    documentation: "https://documentation.lynnux.xyz/akira/search/anime",
    type: "messageCreate",
...
$c[----------------------------------ONLY-IF---------------------------------]
    ...
    $onlyIf[$message!=;$color[$getVar[color;error]]$title[Oops!]$description[Wrong usage of "$getVar[prefix;$serverID]anime", please use "$getVar[prefix;$serverID]anime <Anime Name>".]]
$c[----------------------------------PRELET----------------------------------]
    $let[anime;$replace[$message; ;%20;-1]]
...
$c[----------------------------------ONLYIF----------------------------------]
    $onlyIf[$get[TitleDefault]!=;$color[$getVar[color;error]]$title[Oh no thats not supposed to happen!]$description[The anime "\`$message\`" couldn't be found, please check your spelling or try again later.]]
