module.exports = [{
  ...
  module: "Utility",
  sourcecode: "https://github.com/LynnuxDev/Akira/blob/main/SRC/commands/utility/userInfo.js",
  documentation: "https://documentation.lynnux.xyz/commands/information/userinfo",
  usage: "userinfo {user}",
